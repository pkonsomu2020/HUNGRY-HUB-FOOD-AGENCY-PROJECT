...
function scrollPage(direction) {
  const scrollSpeed = 10; // You can adjust the scroll speed

  // Get the current position of the page
  const currentPosition = window.scrollY;

  // Calculate the target position based on the scroll direction
  const targetPosition = currentPosition + direction * scrollSpeed;
